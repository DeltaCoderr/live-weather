(function(global) {
  ...
  function thunderbolts(ctx, t, cx, cy, cw, color) {
    ...
    var alpha = 1 - (t % 1),
      ...
      b = Math.floor(t % 4),
      x = (x =
        cx + ((b - 1.5) / 1.5) * (b === 1 || b === 2 ? -1 : 1) * cw * 0.16),
      y = cy;
  ...
  var Skycons = function(opts) {
    ...
    this.interval = null;
    this.monochrome =
      typeof opts.monochrome === "undefined" ? true : opts.monochrome;
